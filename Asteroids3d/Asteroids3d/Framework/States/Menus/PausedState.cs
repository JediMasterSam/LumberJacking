...
// Type: Asteroids3d.Framework.States.Menus.PausedState
...
{
  public class PausedState : MenuState
  {
    public PausedState()
      : base("PAUSED")
    {
      ...
      Button button1 = new Button("RESUME", State.Game, new Vector2(x, y), Color.White, Color.Yellow);
      Button button2 = new Button("MAIN MENU", State.MainMenu, new Vector2(x, (float) (button1.Rectangle.Bottom + 50)), Color.White, Color.Yellow);
